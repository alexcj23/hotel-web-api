...
public class Cuarto {
	...
	/**
	 * ^Anchor the regex at the start of the string [\w ] Match an alphanumeric
	 * character, underscore or space + one or more times $ Anchor the regex at
	...
	public Cuarto(final Short numero, final String descripcion, final Integer categoria) {
		this(0, numero, descripcion, categoria);
	}

	public Cuarto(final Integer id, final Short numero, final String descripcion, final Integer categoria) {
		this.id = id;
		this.numero = numero;
