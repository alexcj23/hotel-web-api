...
/**
 * 
 * Le indica a apring que esta clase hará el manejo de las excepciones en
 * nuestra aplicación.
 * 
 * @author fmedina
 *
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler({ IllegalArgumentException.class, InvalidFormatException.class, MethodArgumentTypeMismatchException.class, ConversionFailedException.class })
